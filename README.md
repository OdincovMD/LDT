...
5. **Деплой на сервер.**
   Проект развернут на прод‑домене **[https://ldt-ctg.ru](https://ldt-ctg.ru)** (Nginx → FastAPI/React) с HTTPS, корректным проксированием **WS/SSE** и оптимизированными заголовками.
