/**
 * @component App
 * @description Главный компонент приложения. Управляет маршрутизацией и защитой роутов, разрешает отображение страниц в зависимости от состояния аутентификации.
 */
