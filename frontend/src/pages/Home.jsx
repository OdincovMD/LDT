/**
 * @component Home
 * @description Страница "Главная". Содержит информацию о пользователе, а также предоставляет краткое описание системы мониторинга состояния плода и возможности платформы.
 */
