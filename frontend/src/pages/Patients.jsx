/**
 * @component Patients
 * @description Страница управления пациентами текущего пользователя. Отображает список пациентов, позволяет добавлять новых, осуществлять поиск и сортировку по ФИО.
 */
