 ...
 * @description Компонент - отображение предупржеждения. Отображается, когда ML модель возвращает предсказание с alert = 1. Включает описание вероятности развития гипоксии и время пояявления.
 */
