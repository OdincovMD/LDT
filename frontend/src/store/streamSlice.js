/**
 * @file streamSlice.js
 * @description Redux slice для управления состояниями потоковых данных и режимов работы. Обрабатывает запись, просмотр данных, состояние подключения и ошибки.
 */
